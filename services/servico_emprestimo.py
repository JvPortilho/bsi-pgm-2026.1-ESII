# ServicoEmprestimo: controlar operações de empréstimo.
...
class ServicoEmprestimo:
    ...
    def registrar_emprestimo(
        ...
        self.notificador.enviar_confirmacao(
            email,
            data_limite
        )
    ...
    def verificar_atrasos(self):
        ...
        for emprestimo in (
            ...
            if (
                ...
                self.notificador.enviar_aviso_atraso(
                    emprestimo.email
                )
